  ...
  ({ className, label, error, id, options, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        {label && (
          <label htmlFor={selectId} className="block font-mono text-xs text-zinc-400 uppercase tracking-wider mb-2">
            {label}
          </label>
        )}
        <select
          ...
          id={selectId}
          className={clsx(
            'w-full px-3 py-2.5 bg-zinc-950 border border-zinc-700/80 rounded-lg text-zinc-200 text-sm cursor-pointer appearance-none min-h-[44px]',
            'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:ring-offset-[#050505] focus:border-zinc-600 focus:ring-zinc-500/30 transition-colors duration-150',
